...
public class NewsAdapter extends ArrayAdapter<com.example.android.newsapp1.Feed> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView dateViewCustom = (TextView) listItemView.findViewById(R.id.date);
        ...
        TextView authorTextView = (TextView) listItemView.findViewById(R.id.fullnameauthor);
        authorTextView.setText(currentFeed.getAuthorFullName());
        TextView sectionNameTextView = (TextView) listItemView.findViewById(R.id.feedsection);
        sectionNameTextView.setText(currentFeed.getSectionName());
        TextView titleNameTextView = (TextView) listItemView.findViewById(R.id.titlename);
